        ...
        <div style={{ background:"var(--bg-card)", border:"1px solid var(--border-light)", borderRadius:20, padding:"28px 28px 24px", boxShadow:"0 4px 24px rgba(28,25,23,.08)" }}>
          ...
          <div style={{ marginBottom:12 }}>
            ...
            <input
              ...
              style={{ width:"100%", padding:"10px 14px", borderRadius:10, border:"1px solid var(--border)", background:"var(--surface)", color:"var(--text-primary)", fontFamily:"var(--font-dm-sans)", fontSize:13, outline:"none", transition:"border-color .15s" }}
            />
          </div>
