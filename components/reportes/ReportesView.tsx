...
const MONTHLY_DATA = [
  { month:"Jul", sessions:38, hours:32 },
  { month:"Ago", sessions:42, hours:35 },
  { month:"Sep", sessions:39, hours:33 },
  { month:"Oct", sessions:45, hours:38 },
  { month:"Nov", sessions:41, hours:34 },
  { month:"Dic", sessions:36, hours:30 },
...
export function ReportesView() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", maxWidth: 1280, margin: "0 auto" }}>
      ...
      {/* Tabs */}
      <div style={{ display: "flex", borderBottom: "1px solid var(--border-light)", marginBottom: 24, flexShrink: 0 }}>
              ...
              <Card>
                ...
                <div style={{ display: "flex", alignItems: "flex-end", gap: 6, height: 140, paddingBottom: 4 }}>
                  {MONTHLY_DATA.map((d, i) => (
                    <div key={i} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6, flex: 1, cursor: "default" }}>
        ...
        {tab === "tests" && (
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
            <Card>
              ...
              {[
                { name:"GAD-7",  count:18, color:"#C47B2B" },
                { name:"PHQ-9",  count:14, color:"#4A7BA7" },
                { name:"BDI-II", count:9,  color:"#B5594A" },
                { name:"PCL-5",  count:6,  color:"#5C8A6E" },
                { name:"AUDIT",  count:3,  color:"#7B6EA8" },
              ].map((t, i) => (
            ...
            <Card>
              ...
              {[
                { label:"Mínimo",  range:"0–4",   count:4, color:"var(--green)" },
                { label:"Leve",    range:"5–9",   count:8, color:"var(--blue)"  },
                { label:"Moderado",range:"10–14", count:4, color:"var(--amber)" },
                { label:"Severo",  range:"15–21", count:2, color:"var(--red)"   },
              ].map((s, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 12 }}>
